...
{
    class TeamMember1302200003
    {
        public TeamMember[] members { get; set; }

        public void ReadJSON()
        {
            string fileName = "jurnal7_2_1302200003.json";

            string jsonString = File.ReadAllText(fileName);
            TeamMember1302200003 jsonData = JsonSerializer.Deserialize<TeamMember1302200003>(jsonString);
